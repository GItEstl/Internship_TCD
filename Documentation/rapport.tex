...
\tabto{0cm} {\large \textbf{Condition Instruction}}
\begin{prooftree}
\AxiomC{$s_1 \vdash e_1 \Downarrow true $}
\AxiomC{$s_1 \vdash i_1 \Downarrow \emptyset, s_2$}
\BinaryInfC{$s_1 \vdash if \ e_1 \ then \ i_1 \ else \ i_2  \Downarrow \emptyset, s_2 $}
\end{prooftree}
\vspace*{1pt}
\begin{prooftree}
\AxiomC{$s_1 \vdash e_1 \Downarrow true $}
\AxiomC{$s_1 \vdash i_1 \Downarrow v, s_2$}
\BinaryInfC{$s_1 \vdash if \ e_1 \ then \ i_1 \ else \ i_2  \Downarrow v, s_2 $}
\end{prooftree}
\vspace*{1pt}
\begin{prooftree}
\AxiomC{$s_1 \vdash e_1 \Downarrow false $}
